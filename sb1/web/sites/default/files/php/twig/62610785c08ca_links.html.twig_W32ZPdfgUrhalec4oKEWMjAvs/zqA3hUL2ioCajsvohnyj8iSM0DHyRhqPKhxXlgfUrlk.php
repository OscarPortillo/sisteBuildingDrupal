...
class __TwigTemplate_97b07208437244ba6fa6d51e9073fd32 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["links"] ?? null)) {
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["item"]) {
                // line 44
                echo "<li";
                echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["item"], "attributes", [], "any", false, false, true, 44), "addClass", [0 => "w3-left w3-small read-more"], "method", false, false, true, 44), 44, $this->source), "html", null, true);
                echo ">";
                // line 45
...
{% if links -%}
  ...
  <ul{{ attributes.addClass('w3-ul') }}>
    {%- for item in links -%}
      <li{{ item.attributes.addClass('w3-left w3-small read-more') }}>
        {%- if item.link -%}
          {{ item.link }}
...
{%- endif %}
", "themes/contrib/d8w3css/templates/navigation/links.html.twig", "/var/www/html/web/themes/contrib/d8w3css/templates/navigation/links.html.twig");
    }
