...
class __TwigTemplate_ef0fc9c78f5e8e91d926d19d2135dd33 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div class=\"site-name-slogan\">
  {% if site_name %}
    <h1 class=\"site-name w3-show-block\">
      <a class=\"site-name-link\" href=\"{{ path('<front>') }}\" title=\"{{ 'Home'|t }}\" rel=\"home\">{{ site_name }}</a>
    </h1>
  {% endif %}
  {% if site_slogan %}
    <h3 class=\"site-slogan w3-show-block\">{{ site_slogan }}</h3>
  {% endif %}
</div>
{% endblock %}
", "themes/contrib/d8w3css/templates/block/block--system-branding-block.html.twig", "/var/www/html/web/themes/contrib/d8w3css/templates/block/block--system-branding-block.html.twig");
    }
