...
class __TwigTemplate_2663c39c401228f3cc095ee6e40fa844 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<div id=\"main-navigation-v\" class=\"main-navigation-wrapper w3-sidebar w3-bar-block w3-animate-left w3-theme {{ color_primary_menu }}\" role=\"navigation\" aria-label=\"{{ 'Main Navigation'|t }}\">
  <div id=\"main-navigation-inner-v\" class=\"main-navigation-inner-v\">
    <div id=\"close-nav\" class=\"close-nav w3-button w3-bar-block w3-large w3-theme {{ color_primary_menu }}\">
      <i class=\"fa fa-close\"></i>
    </div>
...
<div class=\"page-wrapper w3-col w3-clear w3-animate-opacity w3-text-theme {{ color_page_wrapper }}\">
  ...
  <header id=\"header\" class=\"w3-col w3-clear w3-theme-l4 {{ sitename_animation }} {{ color_header }}\" role=\"banner\" aria-label=\"{{ 'Site header'|t }}\">
    <div id=\"header-inner\" class=\"w3-container header-inner {{ website_width }}\">
      {% if page.primary_menu_vertical %}
      <div id=\"open-nav-inner\" class=\"open-nav-inner w3-opacity w3-hover-opacity-off w3-left w3-button w3-left-align w3-large w3-theme {{ color_primary_menu }}\">
        <i class=\"fa fa-bars\"></i>
      </div>
      {% endif %}
      {% if page.header %}
  ...
  <!-- Start: Main -->
  <div id=\"main-container\" class=\"w3-col w3-clear w3-theme-l5 {{ color_main }}\">
    <div id=\"main-container-inner\" class=\"w3-row main-container-inner {{ website_width }}\">
      ...
      <div class=\"w3-col w3-clear w3-row-padding\">
        ...
        {% if page.content %}
        <!-- Start: Main Content -->
        <div class=\"{{ content_w3css }} main-box {{ main_region ? 'main-region' }} w3css-content\" role=\"main\">
  ...
  {% if is_front %}
    {% if page.bottom_first or page.bottom_second or page.bottom_third or page.bottom_forth %}
      <!-- Start: Bottom -->
  <div id=\"bottom-container\" class=\"w3-col w3-clear w3-theme-l2 {{ color_bottom_container }}\">
    <div id=\"bottom-container-inner\" class=\"w3-row-padding bottom-container-inner {{ website_width }}\">
      {% if page.bottom_first %}
      <!-- Start: Bottom First -->
      <div class=\"{{ bottom_w3css }} bottom-box {{ bottom_region ? 'bottom-region' }} first-bottom\">
        <div class=\"d8-fade w3-mobile {{ border_animation ? 'animate-border' }} w3-theme-l4 {{ color_bottom_first }}\">
          {{ page.bottom_first }}
        </div>
      </div>
      <!-- End: Bottom First -->
      ...
      <!-- Start: Bottom Second -->
      <div class=\"{{ bottom_w3css }} bottom-box {{ bottom_region ? 'bottom-region' }} second-bottom\">
        <div class=\"d8-fade w3-mobile {{ border_animation ? 'animate-border' }} w3-theme-l4 {{ color_bottom_second }}\">
          {{ page.bottom_second }}
        </div>
      </div>
      <!-- End: Bottom Second -->
      ...
      <!-- Start: Bottom Third  -->
      <div class=\"{{ bottom_w3css }} bottom-box {{ bottom_region ? 'bottom-region' }} third-bottom\">
        <div class=\"d8-fade w3-mobile {{ border_animation ? 'animate-border' }} w3-theme-l4 {{ color_bottom_third }}\">
          {{ page.bottom_third }}
        </div>
      </div>
      <!-- End: Bottom Third -->
      ...
      <!-- Start: Bottom Forth  -->
      <div class =\"{{ bottom_w3css }} bottom-box {{ bottom_region ? 'bottom-region' }} forth-bottom\">
        <div class=\"d8-fade w3-mobile {{ border_animation ? 'animate-border' }} w3-theme-l4 {{ color_bottom_forth }}\">
          {{ page.bottom_forth }}
        </div>
      </div>
      <!-- End: Bottom Forth -->
  ...
  <!-- start: Footer -->
  <div id=\"footer-container\" class=\"w3-col w3-clear w3-theme-d3 {{ color_footer_container }}\">
    <div id=\"footer-container-inner\" class=\"w3-row-padding footer-container-inner {{ website_width }}\">

      {% if page.footer_first %}
      <!-- Start: Footer First  -->
      <div class=\"{{ footer_w3css }} footer-box {{ footer_region ? 'footer-region' }} first-footer\">
        <div class=\"d8-fade w3-mobile {{ border_animation ? 'animate-border' }} w3-theme-l4 {{ color_footer_first }}\">
          {{ page.footer_first }}
        </div>
      </div>
      <!-- End: Footer First -->
      ...
      <div class=\"{{ footer_w3css }} footer-box {{ footer_region ? 'footer-region' }} second-footer\">
        <div class=\"d8-fade w3-mobile {{ border_animation ? 'animate-border' }} w3-theme-l5 {{ color_footer_second }}\">
          {{ page.footer_second }}
        </div>
      </div>
    <!-- End: Footer Second -->
      ...
      <!-- Start: Footer Third -->
      <div class=\"{{ footer_w3css }} footer-box {{ footer_region ? 'footer-region' }} third-footer\">
        <div class=\"d8-fade w3-mobile {{ border_animation ? 'animate-border' }} w3-theme-l4 {{ color_footer_third }}\">
          {{ page.footer_third }}
        </div>
      </div>
      <!-- End: Footer Third -->
  ...
  {% if page.footer_menu or show_social_icon %}
    <!-- Start: Footer Menu -->
  <div id=\"footer-menu\" class=\"w3-col w3-clear w3-theme-d4 {{ color_footer_menu }}\">
    <div id=\"footer-menu-inner\" class=\"w3-row footer-menu-inner {{ website_width }}\">
      {% if show_social_icon %}
        <!-- Start: Social Media -->
      <div class=\"d8-fade w3-center w3-container w3-mobile social-media\">
        {% if facebook_url %}
        <a href=\"{{ facebook_url }}\" class=\"w3-opacity w3-hover-opacity-off w3-hover-text-blue w3-show-inline-block w3-xlarge w3-padding\" target=\"_blank\" ><i class=\"fa fa-facebook\"></i></a>
        {% endif %}
        {% if twitter_url %}
        <a href=\"{{ twitter_url }}\" class=\"w3-opacity w3-hover-opacity-off w3-hover-text-blue w3-show-inline-block w3-xlarge w3-padding\" target=\"_blank\" ><i class=\"fa fa-twitter\"></i></a>
        {% endif %}
        {% if pinterest_url %}
        <a href=\"{{ pinterest_url }}\" class=\"w3-opacity w3-hover-opacity-off w3-hover-text-red w3-show-inline-block w3-xlarge w3-padding\" target=\"_blank\"><i class=\"fa fa-pinterest\"></i></a>
        {% endif %}
        {% if google_plus_url %}
        <a href=\"{{ google_plus_url }}\" class=\"w3-opacity w3-hover-opacity-off w3-hover-text-red w3-show-inline-block w3-xlarge w3-padding\" target=\"_blank\" ><i class=\"fa fa-google-plus\"></i></a>
        {% endif %}
        {% if linkedin_url %}
        <a href=\"{{ linkedin_url }}\" class=\"w3-opacity w3-hover-opacity-off w3-hover-text-blue w3-show-inline-block w3-xlarge w3-padding\" target=\"_blank\"><i class=\"fa fa-linkedin\"></i></a>
        {% endif %}
        {% if instagram_url %}
        <a href=\"{{ instagram_url }}\" class=\"w3-opacity w3-hover-opacity-off w3-hover-text-red w3-show-inline-block w3-xlarge w3-padding\" target=\"_blank\"><i class=\"fa fa-instagram\"></i></a>
        {% endif %}
        {% if youtube_url %}
        <a href=\"{{ youtube_url }}\" class=\"w3-opacity w3-hover-opacity-off w3-hover-text-red w3-show-inline-block w3-xlarge w3-padding\" target=\"_blank\"><i class=\"fa fa-youtube\"></i></a>
        {% endif %}
        {% if drupal_url %}
        <a href=\"{{ drupal_url }}\" class=\"w3-opacity w3-hover-opacity-off w3-hover-text-blue w3-show-inline-block w3-xlarge w3-padding\" target=\"_blank\" ><i class=\"fa fa-drupal\"></i></a>
        {% endif %}
        {% if rss_url %}
        <a href=\"{{ rss_url }}\" class=\"w3-opacity w3-hover-opacity w3-hover-text-red w3-show-inline-block w3-xlarge w3-padding\" target=\"_blank\" ><i class=\"fa fa-rss\"></i></a>
        {% endif %}
      </div>
      <!-- End: Social Media -->
      {% endif %}
  ...
  <!-- Start: Copyright -->
  <div id=\"copyright\" class=\"w3-col w3-clear w3-theme-d5 {{ color_copyright }}\">
...
<!-- End: Page Wrapper -->
", "themes/contrib/d8w3css/templates/layout/page.html.twig", "/var/www/html/web/themes/contrib/d8w3css/templates/layout/page.html.twig");
    }
