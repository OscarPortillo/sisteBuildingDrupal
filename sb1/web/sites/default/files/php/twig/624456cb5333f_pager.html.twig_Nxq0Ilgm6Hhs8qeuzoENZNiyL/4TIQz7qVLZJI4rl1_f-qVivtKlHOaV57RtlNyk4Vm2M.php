...
class __TwigTemplate_10b9628c74a8d41f4aff8d0cba4c33e9 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
#}
{% if items %}
  <nav class=\"w3-center pager\" role=\"navigation\" aria-labelledby=\"{{ heading_id }}\">
    ...
    <ul class=\"w3-bar pager__items js-pager__items\">
      ...
      {% for key, item in items.pages %}
        <li class=\"w3-button pager__item{{ current == key ? ' w3-light-gray w3-active-pager is-active' : '' }}\">
          {% if current == key %}
...
{% endif %}
", "themes/contrib/d8w3css/templates/navigation/pager.html.twig", "/var/www/html/web/themes/contrib/d8w3css/templates/navigation/pager.html.twig");
    }
