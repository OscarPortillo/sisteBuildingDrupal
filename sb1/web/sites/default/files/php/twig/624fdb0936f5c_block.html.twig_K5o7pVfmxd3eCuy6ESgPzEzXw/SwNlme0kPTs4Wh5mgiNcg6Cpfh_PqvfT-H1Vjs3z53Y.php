...
/* block.html.twig */
class __TwigTemplate_207514e088e57594f2bb4b91f86dddf4 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
<section{{ attributes.addClass(classes) }}>
  {{ title_prefix }}
  {% if label %}
    <h2{{ title_attributes.addClass('w3-block-title') }}>{{ label }}</h2>
  {% endif %}
  {{ title_suffix }}
  {% block content %}
    {{ content }}
...
", "block.html.twig", "themes/contrib/d8w3css/templates/block/block.html.twig");
    }
