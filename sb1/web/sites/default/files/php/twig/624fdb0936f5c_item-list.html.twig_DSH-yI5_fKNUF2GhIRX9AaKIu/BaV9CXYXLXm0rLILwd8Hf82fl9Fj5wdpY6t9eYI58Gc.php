...
/* themes/contrib/d8w3css/templates/dataset/item-list.html.twig */
class __TwigTemplate_d10044f5660800e6969784b0585830a6 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    {
        return "themes/contrib/d8w3css/templates/dataset/item-list.html.twig";
    }
...
{% endif %}
{% if items or empty -%}
  <div{{ wrapper_attributes.addClass('w3-row item-list') }}>
    {%- if title is not empty -%}
      <h3>{{ title }}</h3>
    {%- endif -%}
    {%- if items -%}
      <{{ list_type }}{{ attributes.addClass('w3-ul') }}>
        {%- for item in items -%}
          <li{{ item.attributes.addClass('w3-panel') }}>{{ item.value }} </li>
        {%- endfor -%}
      </{{ list_type }}>
    {%- else -%}
      {{- empty -}}
...
{%- endif %}
", "themes/contrib/d8w3css/templates/dataset/item-list.html.twig", "/var/www/html/web/themes/contrib/d8w3css/templates/dataset/item-list.html.twig");
    }
