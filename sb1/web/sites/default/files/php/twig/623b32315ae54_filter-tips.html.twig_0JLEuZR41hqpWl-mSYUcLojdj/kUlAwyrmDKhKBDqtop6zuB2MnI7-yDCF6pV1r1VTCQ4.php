...
class __TwigTemplate_ba6ccdbffea935d6d731330a4d4abd2b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-" . twig_replace_filter($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 45), 45, $this->source), ["/" => "-"]))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "themes/contrib/d8w3css/templates/content-edit/filter-tips.html.twig", "/var/www/html/web/themes/contrib/d8w3css/templates/content-edit/filter-tips.html.twig");
    }
