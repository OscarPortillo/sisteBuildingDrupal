...
class __TwigTemplate_9ca458d36952ba7651969e03b1fb7e56 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
{% if primary %}
  ...
  <ul class=\"w3-ul w3-bar tabs primary\">{{ primary }}</ul>
{% endif %}
{% if secondary %}
  <h2 class=\"visually-hidden\">{{ 'Secondary tabs'|t }}</h2>
  <ul class=\"w3-ul w3-small w3-bar tabs secondary\">{{ secondary }}</ul>
{% endif %}
", "themes/contrib/d8w3css/templates/navigation/menu-local-tasks.html.twig", "/var/www/html/web/themes/contrib/d8w3css/templates/navigation/menu-local-tasks.html.twig");
    }
