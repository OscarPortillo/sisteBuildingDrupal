...
/* themes/contrib/d8w3css/templates/views/views-view-list.html.twig */
class __TwigTemplate_9b86ba8601d0e24477e8163fee9def9f extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
  ...
  <";
        ...
        echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, ($context["attributes"] ?? null), "addClass", [0 => "w3-ul"], "method", false, false, true, 26), 26, $this->source), "html", null, true);
        echo ">
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
            // line 29
            echo "      <li";
            echo $this->extensions['Drupal\Core\Template\TwigExtension']->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, $context["row"], "attributes", [], "any", false, false, true, 29), "addClass", [0 => "w3-panel"], "method", false, false, true, 29), 29, $this->source), "html", null, true);
            echo ">";
...
";
    ...
    {
        return "themes/contrib/d8w3css/templates/views/views-view-list.html.twig";
    }
    ...
    {
        return array (  91 => 35,  89 => 34,  84 => 32,  81 => 31,  70 => 29,  66 => 28,  59 => 26,  56 => 25,  50 => 23,  47 => 22,  41 => 20,  39 => 19,);
    }
...
{% endif %}
", "themes/contrib/d8w3css/templates/views/views-view-list.html.twig", "/var/www/html/web/themes/contrib/d8w3css/templates/views/views-view-list.html.twig");
    }
